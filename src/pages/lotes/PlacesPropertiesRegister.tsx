...
export const PlacesPropertiesRegister = () => {
  ...
  function onSubmit(data: FormData) {
    ...
    const propertyListImages = propertyImages.map((placeGround) => {
      return {
        uid: placeGround.uid,
        name: placeGround.name,
        url: placeGround.url
      }
    })
  ...
  return (
    <Container>
      <h1 className="text-center text-4xl mb-14 font-bold text-indigo-700 mt-14">
        <span className="text-gray-500">Cadastrar Lotes</span> RE
