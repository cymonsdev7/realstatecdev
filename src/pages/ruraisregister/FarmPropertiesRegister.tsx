...
export const FarmsPropertiesRegister = () => {
  ...
  function onSubmit(data: FormData) {
    ...
    const propertyListImages = propertyImages.map((farmsGround) => {
      return {
        uid: farmsGround.uid,
        name: farmsGround.name,
        url: farmsGround.url
      }
    })

    addDoc(collection(db, 'rurais'), {
  ...
  return (
    <Container>
      <h1 className="text-center text-4xl mb-14 font-bold text-indigo-700 mt-14">
        <span className="text-gray-500">Cadastrar Rurais</span> RE
