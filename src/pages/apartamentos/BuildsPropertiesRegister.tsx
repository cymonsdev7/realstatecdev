...
export const BuildsPropertiesRegister = () => {
  ...
  function onSubmit(data: FormData) {
    ...
    const propertyListImages = propertyImages.map((builds) => {
      return {
        uid: builds.uid,
        name: builds.name,
        url: builds.url
    ...
    addDoc(collection(db, 'apartamentos'), {
  ...
  return (
    <Container>
      <h1 className="text-center text-4xl mb-14 font-bold text-indigo-700 mt-14">
        <span className="text-gray-500">Cadastrar Aptos</span> RE
