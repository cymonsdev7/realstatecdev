...
const schema = z.object({
  ...
  whatsapp: z.string().nonempty('O campo nome é obrigatório'),
...
export const ContatoPage = () => {
  ...
  function onSubmit(data: FormData) {
    ...
    addDoc(collection(db, 'contactpage'), {
  ...
  return (
    <Container>
      ...
      <h1 className="text-center text-4xl mb-14 font-bold text-indigo-700">
        ...
        <span className="font-bold text-red-600 relative -top-1">/</span>MAX
      </h1>
      ...
      <div className="w-full bg-white shadow-md p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2 mt-2">
        <form onSubmit={handleSubmit(onSubmit)} className="w-full">
          <div className="grid md:grid-cols-2 items-center gap-4">
            <div className="mb-3">
              <p className="mb-2 font-bold">Seu Primeiro Nome</p>
              <Input
                type="text"
                register={register}
                name="name"
            ...
            <div className="mb-3">
              <p className="mb-2 font-bold">Seu Melhor Email</p>
              <Input
                type="email"
                register={register}
                name="email"
